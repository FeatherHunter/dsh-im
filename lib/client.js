...
var BASE_ID = PACKAGE_NAME.replace(/^@/, "").replace(/\//g, "-").replace(/_/g, "-");
...
var PACKAGE_NAME2 = package_default.name;
var BASE_ID2 = PACKAGE_NAME2.replace(/^@/, "").replace(/\//g, "-").replace(/_/g, "-");
var DISCORD_STYLE_ID = `${BASE_ID2}-discord-settings`;
var CSS2 = String.raw`
...
function installDiscordStyles() {
  ...
  const style = document.createElement("style");
  style.dataset.plugin = PACKAGE_NAME2;
...
var PACKAGE_NAME3 = package_default.name;
var BASE_ID3 = PACKAGE_NAME3.replace(/^@/, "").replace(/\//g, "-").replace(/_/g, "-");
var FEISHU_STYLE_ID = `${BASE_ID3}-feishu-settings`;
var CSS3 = String.raw`
.bxf-page {
...
function installFeishuStyles() {
  ...
  const style = document.createElement("style");
  style.dataset.plugin = PACKAGE_NAME3;
...
var PACKAGE_NAME4 = package_default.name;
var BASE_ID4 = PACKAGE_NAME4.replace(/^@/, "").replace(/\//g, "-").replace(/_/g, "-");
var QQ_STYLE_ID = `${BASE_ID4}-qq-settings`;
var CSS4 = String.raw`
...
function installQqStyles() {
  ...
  const style = document.createElement("style");
  style.dataset.plugin = PACKAGE_NAME4;
...
var PACKAGE_NAME5 = package_default.name;
var BASE_ID5 = PACKAGE_NAME5.replace(/^@/, "").replace(/\//g, "-").replace(/_/g, "-");
var OFFICE_STYLE_ID = `${BASE_ID5}-office-settings`;
var CSS5 = `
...
var PACKAGE_NAME6 = package_default.name;
var BASE_ID6 = PACKAGE_NAME6.replace(/^@/, "").replace(/\//g, "-").replace(/_/g, "-");
var SLACK_STYLE_ID = `${BASE_ID6}-slack-settings`;
var CSS6 = String.raw`
...
function installSlackStyles() {
  ...
  const style = document.createElement("style");
  style.dataset.plugin = PACKAGE_NAME6;
...
var PACKAGE_NAME7 = package_default.name;
var BASE_ID7 = PACKAGE_NAME7.replace(/^@/, "").replace(/\//g, "-").replace(/_/g, "-");
var TELEGRAM_STYLE_ID = `${BASE_ID7}-telegram-settings`;
var CSS7 = String.raw`
...
function installTelegramStyles() {
  ...
  const style = document.createElement("style");
  style.dataset.plugin = PACKAGE_NAME7;
...
var PACKAGE_NAME8 = package_default.name;
var BASE_ID8 = PACKAGE_NAME8.replace(/^@/, "").replace(/\//g, "-").replace(/_/g, "-");
var WECOM_STYLE_ID = `${BASE_ID8}-wecom-settings`;
var CSS8 = String.raw`
...
function installWecomStyles() {
  ...
  const style = document.createElement("style");
  style.dataset.plugin = PACKAGE_NAME8;
...
var PACKAGE_NAME9 = package_default.name;
var BASE_ID9 = PACKAGE_NAME9.replace(/^@/, "").replace(/\//g, "-").replace(/_/g, "-");
var WEIXIN_STYLE_ID = `${BASE_ID9}-weixin-settings`;
var CSS9 = String.raw`
.dxw-page {
  --dxw-accent: #07c160;
...
function installWeixinStyles() {
  ...
  const style = document.createElement("style");
  style.dataset.plugin = PACKAGE_NAME9;
...
var PACKAGE_NAME10 = package_default.name;
var BASE_ID10 = PACKAGE_NAME10.replace(/^@/, "").replace(/\//g, "-").replace(/_/g, "-");
var WHATSAPP_STYLE_ID = `${BASE_ID10}-whatsapp-settings`;
...
function installWhatsappStyles() {
  ...
  const style = document.createElement("style");
  style.dataset.plugin = PACKAGE_NAME10;
...
var PACKAGE_NAME11 = package_default.name;
var BASE_ID11 = PACKAGE_NAME11.replace(/^@/, "").replace(/\//g, "-").replace(/_/g, "-");
var IM_STYLE_ID = `${BASE_ID11}-settings`;
...
function installImStyles() {
  ...
  const style = document.createElement("style");
  style.dataset.plugin = PACKAGE_NAME11;
...
var PACKAGE_NAME12 = package_default.name;
...
function manualUpdateCommand(snapshot) {
  ...
  return `dsh plugin --profile ${profileArgument} add -w ${PACKAGE_NAME12}@${version}`;
}
function ManualUpdateCommand({ command, disabled, sourceInstall, desktop }) {
  ...
  return h2(
    ...
    command ? h2(
      ...
      command.endsWith(`${PACKAGE_NAME12}@latest`) ? h2(
        "p",
...
// plugin-src/client/index.js
var PACKAGE_NAME13 = package_default.name;
var PLUGIN_ID = PACKAGE_NAME13.replace(/^@/, "").replace(/\//g, "-").replace(/_/g, "-");
